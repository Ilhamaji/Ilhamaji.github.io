...
export function HeroMinimal() {
  const bio =
    "A motivated Computer Science student and full-stack developer. I specialize in Next.js and Tailwind CSS for the front-end, with Firebase and Node.js on the back-end, and deployment via Google Cloud Platform.";
  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto">
        ...
        >
          <span className="text-accent font-mono text-sm tracking-tighter mb-4 block uppercase opacity-70">
            Full-stack Web Developer
          </span>
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-12 text-foreground">
            M. <span className="opacity-20 italic font-light">Ilham.</span>
          </h1>
        </motion.div>
